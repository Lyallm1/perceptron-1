...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _neural_network_neuron_perceptron__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./neural-network/neuron/perceptron */ \"./src/neural-network/neuron/perceptron.ts\");\n/* harmony import */ var _dynamic_canvas_canvas_canvas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dynamic-canvas/canvas/canvas */ \"./src/dynamic-canvas/canvas/canvas.ts\");\n/* harmony import */ var _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dynamic-canvas/vector/vector */ \"./src/dynamic-canvas/vector/vector.ts\");\n/* harmony import */ var _dynamic_canvas_shapes_ball__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dynamic-canvas/shapes/ball */ \"./src/dynamic-canvas/shapes/ball.ts\");\n/* harmony import */ var _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dynamic-canvas/shapes/line */ \"./src/dynamic-canvas/shapes/line.ts\");\n/* harmony import */ var _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dynamic-canvas/shapes/text */ \"./src/dynamic-canvas/shapes/text.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\nlet perceptron = new _neural_network_neuron_perceptron__WEBPACK_IMPORTED_MODULE_0__.Perceptron(2, 0.001);\r\nlet m = 0.5;\r\nlet b = 0.5;\r\nlet interval;\r\nfunction f(x) {\r\n    return m * x + b;\r\n}\r\nconst canvas = new _dynamic_canvas_canvas_canvas__WEBPACK_IMPORTED_MODULE_1__.Canvas(document.getElementById('graph'), { width: 800, height: 800 });\r\nconst perceptronVisualization = new _dynamic_canvas_canvas_canvas__WEBPACK_IMPORTED_MODULE_1__.Canvas(document.getElementById('perceptron'), { width: 400, height: 300 });\r\nconst lossVisualization = new _dynamic_canvas_canvas_canvas__WEBPACK_IMPORTED_MODULE_1__.Canvas(document.getElementById('loss'), { width: 400, height: 300 });\r\nlet lossHistory = [];\r\nfunction drawGraph(trainingData) {\r\n    const halfWidth = canvas.width / 2;\r\n    const halfHeight = canvas.height / 2;\r\n    canvas.removeShapes();\r\n    trainingData.map(data => new _dynamic_canvas_shapes_ball__WEBPACK_IMPORTED_MODULE_3__.Ball(3, new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(data.values[0] * halfWidth + halfWidth, data.values[1] * halfHeight + halfHeight), data.label === 1 ? 'gold' : 'lightblue', data.error ? 'red' : 'green')).forEach(ball => canvas.addShape(ball));\r\n    canvas.addShape(new _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__.Line(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(0, perceptron.status.f(-1) * halfHeight + halfHeight), new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(canvas.height, perceptron.status.f(1) * halfHeight + halfHeight)));\r\n    canvas.draw();\r\n}\r\nfunction drawPerceptron(p, x, y) {\r\n    perceptronVisualization.removeShapes();\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(5, 56), 'x', '24px'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(5, 156), 'y', '24px'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(5, 255), 'bias', '10px'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_ball__WEBPACK_IMPORTED_MODULE_3__.Ball(25, new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(50, 50), 'white', 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_ball__WEBPACK_IMPORTED_MODULE_3__.Ball(25, new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(50, 150), 'white', 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_ball__WEBPACK_IMPORTED_MODULE_3__.Ball(25, new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(50, 250), 'white', 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__.Line(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(75, 50), new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(175, 150), 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__.Line(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(75, 150), new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(175, 150), 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__.Line(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(75, 250), new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(175, 150), 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(105, 76), p.status.weights[0].toFixed(3)));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(105, 145), p.status.weights[1].toFixed(3)));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(105, 235), p.status.biasWeight.toFixed(3)));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_ball__WEBPACK_IMPORTED_MODULE_3__.Ball(25, new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(200, 150), 'white', 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__.Line(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(225, 150), new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(325, 150), 'black'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(75, 290), `y = ${p.status.m.toFixed(2)}x + ${p.status.b.toFixed(2)}`, '30px'));\r\n    perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(40, 255), '1'));\r\n    if (x && y) {\r\n        perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(40, 55), x.toFixed(2)));\r\n        perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(40, 155), y.toFixed(2)));\r\n        const weightedSum = x * p.status.weights[0] + y * p.status.weights[1] + p.status.biasWeight;\r\n        perceptronVisualization.addShape(new _dynamic_canvas_shapes_text__WEBPACK_IMPORTED_MODULE_5__.Text(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(190, 155), weightedSum.toFixed(2)));\r\n        perceptronVisualization.addShape(new _dynamic_canvas_shapes_ball__WEBPACK_IMPORTED_MODULE_3__.Ball(25, new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(360, 150), weightedSum > 0 ? 'gold' : 'lightblue', 'none'));\r\n    }\r\n    perceptronVisualization.draw();\r\n}\r\ncanvas.addEventListener('mousemove', (e) => {\r\n    const graphContainer = document.getElementById('graph');\r\n    const x = (e.clientX - graphContainer.offsetLeft + window.scrollX) / 400 - 1;\r\n    const y = (e.clientY - graphContainer.offsetTop + window.scrollY) / 400 - 1;\r\n    drawPerceptron(perceptron, x, y);\r\n});\r\nfunction drawLossHistory(h) {\r\n    lossVisualization.removeShapes();\r\n    const w = 350 / h.length;\r\n    const m = Math.max(...h);\r\n    lossVisualization.addShape(new _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__.Line(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(25, 25), new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(25, 275)));\r\n    lossVisualization.addShape(new _dynamic_canvas_shapes_line__WEBPACK_IMPORTED_MODULE_4__.Line(new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(25, 275), new _dynamic_canvas_vector_vector__WEBPACK_IMPORTED_MODULE_2__.Vector(375, 275)));\r\n    lossVisualization.draw();\r\n    const ctx = lossVisualization.context;\r\n    ctx.beginPath();\r\n    h.forEach((l, i) => {\r\n        const x = 25 + w * i;\r\n        const y = 275 - l / m * 250;\r\n        ctx.fillText(l + '', x - 3, y - 5);\r\n        if (i === 0)\r\n            ctx.moveTo(x, y);\r\n        else {\r\n            ctx.lineTo(x, y);\r\n            ctx.moveTo(x, y);\r\n        }\r\n    });\r\n    ctx.lineCap = 'round';\r\n    ctx.strokeStyle = 'black';\r\n    ctx.stroke();\r\n}\r\nfunction setM(event) {\r\n    m = Number(event.target?.value);\r\n}\r\nfunction setB(event) {\r\n    b = Number(event.target?.value);\r\n}\r\nfunction startTraining() {\r\n    if (interval) {\r\n        clearInterval(interval);\r\n        interval = null;\r\n    }\r\n    perceptron = new _neural_network_neuron_perceptron__WEBPACK_IMPORTED_MODULE_0__.Perceptron(2, 0.001);\r\n    const trainingData = new Array(500).fill(0).map(_ => {\r\n        const x = Math.random() * 2 - 1;\r\n        const y = Math.random() * 2 - 1; // TODO: use utils\r\n        const label = (y > f(x) ? 1 : -1);\r\n        return { values: [x, y], label, error: 1 };\r\n    });\r\n    lossHistory = [];\r\n    interval = setInterval(() => {\r\n        if (!trainingData.find(data => data.error)) {\r\n            console.log(`Training completed: ${perceptron.status.m.toFixed(2)} * x + ${perceptron.status.b.toFixed(2)} (expected ${f(1) - f(0)} * x + ${f(0)})`);\r\n            clearInterval(interval);\r\n            return;\r\n        }\r\n        lossHistory.push(perceptron.train(trainingData));\r\n        console.log(`Thinking: ${perceptron.status.m.toFixed(2)} * x + ${perceptron.status.b.toFixed(2)}`);\r\n        drawGraph(trainingData);\r\n        drawPerceptron(perceptron, 0, 0);\r\n        drawLossHistory(lossHistory);\r\n    }, 300);\r\n}\r\ndocument.getElementById('m')?.addEventListener('change', setM);\r\ndocument.getElementById('b')?.addEventListener('change', setB);\r\ndocument.getElementById('train-button')?.addEventListener('click', startTraining);\r\nwindow.addEventListener('load', startTraining);\r\n\n\n//# sourceURL=webpack://perceptron/./src/index.ts?");
